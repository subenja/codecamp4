...
describe(`การเข้ารหัสแบบ Run-length เป็นวิธีการเข้ารหัสสตริงที่่ายและเร็วที่สุด แนวคิดพื้นฐานที่สำคัญคือการนับสตริงแต่ละตัวที่ซ้ำกัน เช่น AABBB มี A สองตัวและ B สามตัวจะเข้ารหัสได้ว่า 2A3B`, () => {
